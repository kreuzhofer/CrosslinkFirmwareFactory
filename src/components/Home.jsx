	...
	render(){
		return (
			<div>
				...
				<p>However, of course you can ping me directly via our <a href="https://discord.gg/ne3J4Rf" target="_blank" rel="noreferrer">discord server in the "#firmware-factory-alpha" channel</a>. You can also use the SUPPORT button on this page (lower right corner).</p>
