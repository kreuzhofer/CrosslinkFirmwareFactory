	...
	render(){
		return (
			<div>
				...
				<h3>TERMS OF USE</h3>
				<p>This website is currently in <strong>alpha</strong> testing, so expect roughness in design, all kinds of bugs and quirks. Functionality is still limited but you see it first, which is awesome!</p>
				...
				<p>However, of course you can ping me directly via our <a href="https://discord.gg/ne3J4Rf">discord server in the "#firmware-factory-alpha" channel</a>. You can also use the SUPPORT button on this page (lower right corner).</p>
