      ...
      <Grid padded>
        ...
        <Grid.Row>
          <Grid.Column>
            ...
            <Route path="/AddBuildDefinition" exact render={(props)=>(<EditBuildDefinition {...props} isAdmin={isAdmin} />)}/>
            <Route path="/AddBuildDefinition/:id" render={(props)=>(<EditBuildDefinition {...props} clone={true} isAdmin={isAdmin} />)}/>
